        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group form-md-line-input has-info text-primary" style="text-align: left;">
                    <label for="fk_id_second_parametric">{!! trans('labels.tipoDeMoneda') !!}(*):</label>
                    {!!Form::select('fk_id_second_parametric',$currencys, (isset($contractConfiguration) ? $contractConfiguration->fk_id_second_parametric : null) ,[
                        'class'=>'form-control selectpicker fk_id_second_parametric is_required',
                        'data-live-search'=>'true',
                        'title'=>'',
                        'id'=>'fk_id_second_parametric',
                        'data-size'=>'5'
                    ])!!}
