        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group form-md-line-input has-info text-primary" style="text-align: left;">
                    ...
                    {!!Form::select('fk_id_activity',$activities, (isset($contract) ? $contract->fk_id_activity : null) ,[
            ...
            <div class="col-md-6">
                <div class="form-group form-md-line-input has-info text-primary" style="text-align: left;">
                    ...
                    {!! Form::number('value', isset($contract) ? $contract->value : null, ['class' => 'form-control is_required', 'id' => 'value', 'min'=> '{{$contract->value}}', 'Style' => 'width: 100%;']) !!}
                    <span class="help-block"></span>
                </div>
            </div>
        </div>
