<nav class="main-header navbar navbar-expand navbar-white navbar-light" style="border-bottom:0px solid gray;box-shadow:0px 0px 5px rgba(0,0,0,0.5);">
  <!-- Left navbar links -->
  <ul class="navbar-nav">
    <li class="nav-item">
  ...
  <ul class="navbar-nav ml-auto">
    ...
    @if (config('locale.status') && count(config('locale.languages')) > 1)
      <li class="nav-item">
        ...
        @if(isset($inactive))
        <b><a class="nav-link" href="{!! route('lang.swap', $lang) !!}" title="Cambiar de idioma" style="  pointer-events: none;">
                [ {!! $lang !!} ]
            </a></b>
          @else
